      ...
      >
        <View style={s.sheet}>
          ...
          >
            ...
            <View style={s.toggleContainer}>
              ...
              >
                <Ionicons
                  ...
                  size={16}
                  color={mode === 'phone' ? colors.textPrimary : colors.textMuted}
                />
              ...
              >
                <Ionicons
                  name="mail-outline"
                  size={16}
                  color={mode === 'email' ? colors.textPrimary : colors.textMuted}
                />
            ...
            <TouchableOpacity style={s.socialBtn} activeOpacity={0.8}>
              <AntDesign name="apple1" size={22} color={colors.black} />
