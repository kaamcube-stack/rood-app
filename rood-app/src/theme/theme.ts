...
export const typography = {
  ...
  // ── Spec tokens (Property Description Screen + all future components) ──
  // heading1 — Property name / hero title (32px semibold)
  heading1: {
  ...
  // heading2 — Section headers (24px semibold)
  heading2: {
    fontFamily: 'Urbanist_600SemiBold',
    fontSize: 24,
    lineHeight: 32,
  ...
  // heading3 — Sub-section labels (20px semibold)
  heading3: {
  ...
  // titleLarge — Primary price display (18px semibold)
  titleLarge: {
    fontFamily: 'Inter_600SemiBold',
    fontSize: 18,
    lineHeight: 27,
  ...
  // titleSmall — Price per unit, badges (14px medium)
  titleSmall: {
  ...
  // Headings — Screen titles (legacy aliases, kept for backward compat)
  h1: {
    fontFamily: 'Urbanist_700Bold',
    fontSize: 24,
    lineHeight: 32,
  ...
  // labelLarge: medium (500) per spec — chips/tags should not be bold
  labelLarge: {
    fontFamily: 'Inter_500Medium',
    fontSize: 14,
    lineHeight: 20,
...
// ── Spacing (4pt grid) ───────────────────────────────────────────
// Numeric keys (legacy) + named aliases (spec tokens)
export const spacing = {
  ...
  14: 56,
  16: 64,
  // Named aliases — use these in all new components
  xs: 4,    // Icon gaps, label-to-input
  s: 8,     // Between chips, icon-to-text
  m: 12,    // Card inner spacing, list gaps
  l: 16,    // Screen padding (mobile), row padding
  xl: 24,   // Section spacing (mobile)
  '2xl': 32, // Section spacing (desktop)
  '3xl': 40, // Desktop layout margins
  '4xl': 48, // Hero / large screen areas
} as const;
